...
while ($fila = $result->fetch_assoc()) {
    $salida .= "<area src='../icons/Mesa Redonda 4 Sillas/Mesa Blanco/vacia.gif target='_self' alt='algo' title='algo' href='' coords=\"" . $ancho * ((float)$fila['x']+1) . "," . $largo * ((float)$fila['y']+1) . ",44\" shape='circle'>";
